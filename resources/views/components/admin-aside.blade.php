...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo ">
    <a href="{{ route('admin') }}" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bolder ms-2">DHR</span>
    </a>
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ route('all-users') }}" class="menu-link">
            <div data-i18n="List all">List all</div>
          </a>
        </li>
        <li class="menu-item">
      ...
      <ul class="menu-sub">
        <li class="menu-item">
          <a href="{{ route('all-roles') }}" class="menu-link">
            <div data-i18n="Roles and Permition list">Roles and Permitions list</div>
          </a>
        </li>
        <li class="menu-item">
        ...
        <!-- <li class="menu-item">
          <a href="" class="menu-link">
            <div data-i18n="Users Roles statistics">Users Roles statistics</div>
          </a>
        </li> -->
      </ul>
    </li>
